...
useFormik({
 ...
 if(!details){
   ...
   <div className="fieldBox">
          ...
          />
          <small>
            {formik.errors.recipeName && formik.touched.recipeName ? formik.errors.recipeName : null}
          </small>
        </div>
<div className="fieldBox">
         ...
         
    {
        inputFields.map((input , index)=>{
            return(
                ...
                <small>{formik.errors.step && formik.touched.step ? formik.errors.step : null}</small>
              </div>
            )
        })
    }
          ...
          <div>
          <small>{formik.errors.ingName && formik.touched.ingName ? formik.errors.ingName : null}</small>
            <small>{formik.errors.ingQty && formik.touched.ingQty ? formik.errors.ingQty : null}</small>
          </div>
          ...
          <small>
            {formik.errors.recipeType && formik.touched.recipeType ? formik.errors.recipeType : null}
          </small>
        </div>
        <div className="fieldBox">
        <label>About</label>
        <textarea  htmlFor="about" type="textarea" name="about" onChange={formik.handleChange}
              onBlur={formik.handleBlur}
              value={formik.values.about} id="about" />
        <small>
            {formik.errors.about && formik.touched.about ? formik.errors.about : null}
          </small>
        </div>
